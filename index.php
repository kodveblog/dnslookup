...
<html lang="en">
    <head>
        <!-- kodveblog Dns Lookup Php Script -->
        <meta charset="utf-8">
        ...
        <meta name="author" content="kodveblog">
    ...
    <body>
        <div class="container">
            <div class="header clearfix">
                ...
                <h3 class="text-muted">Simple DNS Lookup - KodveBlog</h3>
            </div>
            
            <?php
            // KodveBlog DnsLookup Script
            ...
            <footer class="footer">
                <p  class="text-center"> Simple DNS Lookup - <a href="https://github.com/kodveblog/">Sourcecode on GitHub</a></p>
            </footer>
            </div> <!-- /container -->
    </body>
</html>
